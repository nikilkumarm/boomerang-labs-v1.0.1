      ...
      <body>
        ...
        <main className="w-full">
          ...
          <footer className="w-full bg-white pt-4 px-6 md:px-12 xl:px-24 relative z-50">
            <div className="max-w-[1440px] mx-auto bg-white rounded-t-[40px] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] border-t border-l border-r border-gray-100 p-10 md:p-16 pb-0 relative overflow-hidden">

              {/* Background Glows */}
              <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-gradient-to-br from-[#2E6BFF]/15 to-transparent rounded-full blur-[100px] -translate-y-1/3 translate-x-1/3 pointer-events-none z-0" />
              <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-gradient-to-tr from-[#06b6d4]/15 to-transparent rounded-full blur-[100px] translate-y-1/3 -translate-x-1/3 pointer-events-none z-0" />
              ...
              <div className="md:col-span-4 flex flex-col gap-6">
                ...
                <nav className="flex flex-col gap-4">
                  ...
                  <Link href="/podcasts" className="text-[15px] font-medium text-gray-600 hover:text-[#2E6BFF] transition-colors">Podcasts</Link>
              ...
              <div className="md:col-span-3 flex flex-col gap-6 md:items-end">
                ...
                <div className="flex items-center gap-4">
                  <a href="https://wa.me/918124887577" target="_blank" rel="noopener noreferrer" className="w-[48px] h-[48px] rounded-full bg-white border border-gray-200 flex items-center justify-center hover:border-[#2E6BFF] hover:text-[#2E6BFF] text-gray-600 transition-all hover:-translate-y-1 shadow-sm" aria-label="WhatsApp">
                  ...
                  <a href="mailto:hello@boomeranglabs.in" className="w-[48px] h-[48px] rounded-full bg-white border border-gray-200 flex items-center justify-center hover:border-[#2E6BFF] hover:text-[#2E6BFF] text-gray-600 transition-all hover:-translate-y-1 shadow-sm" aria-label="Gmail">
                  ...
                  <a href="https://instagram.com/boomerang.in_" target="_blank" rel="noopener noreferrer" className="w-[48px] h-[48px] rounded-full bg-white border border-gray-200 flex items-center justify-center hover:border-[#2E6BFF] hover:text-[#2E6BFF] text-gray-600 transition-all hover:-translate-y-1 shadow-sm" aria-label="Instagram">
            ...
            <div className="w-full flex flex-col md:flex-row items-center justify-between gap-4 pt-8 pb-10 border-t border-gray-100 relative z-10">
