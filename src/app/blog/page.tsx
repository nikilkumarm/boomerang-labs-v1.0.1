      ...
      <section className="w-full pt-40 pb-20 px-6 md:px-12 max-w-[1200px] mx-auto flex flex-col md:flex-row justify-between items-end gap-12 border-b border-slate-300">
        ...
        >
          <p className="text-slate-700 font-medium leading-relaxed">
            An exploration of brand identity, immersive audio, and cinematic post-production. We craft aesthetic systems for the modern digital era.
          </p>
        </motion.div>
      </section>
      ...
      <section className="w-full max-w-[1200px] mx-auto px-6 md:px-12 py-32">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-16 items-start">
          ...
          <div className="flex flex-col group md:mt-0">
            <Link href="/blog/podcasts" className="block relative w-full aspect-square overflow-hidden bg-slate-900 mb-8">
              <Image
            ...
            <h2 className="text-3xl lg:text-4xl font-medium tracking-tight mb-6 leading-none text-slate-900">Audio <br />Environments.</h2>
            ...
            <Link href="/blog/podcasts" className="inline-flex items-center gap-4 text-sm font-bold uppercase tracking-widest border-b-2 border-slate-900 pb-2 text-slate-900 hover:text-blue-600 hover:border-blue-600 transition-colors w-fit mt-auto">
              Explore Podcasts <ArrowRight className="w-4 h-4" />
            </Link>
          </div>

          {/* Feature 2: Video Editing */}
          <div className="flex flex-col group md:mt-0">
            <Link href="/blog/video-editing" className="block relative w-full aspect-square overflow-hidden bg-slate-900 mb-8">
              <Image
            ...
            <h2 className="text-3xl lg:text-4xl font-medium tracking-tight mb-6 leading-none text-slate-900">Cinematic <br />Post-Production.</h2>
            <p className="text-lg text-slate-700 leading-relaxed mb-8 max-w-sm">
              Stories cut to perfection. We architect pacing, structure, and emotional beats designed to capture and hold attention.
            </p>
            <Link href="/blog/video-editing" className="inline-flex items-center gap-4 text-sm font-bold uppercase tracking-widest border-b-2 border-slate-900 pb-2 text-slate-900 hover:text-cyan-600 hover:border-cyan-600 transition-colors w-fit mt-auto">
              Explore Video Editing <ArrowRight className="w-4 h-4" />
            </Link>
          </div>

          {/* Feature 3: Graphic Design */}
          <div className="flex flex-col group md:mt-0">
            <Link href="/blog/graphic-design" className="block relative w-full aspect-square overflow-hidden bg-slate-900 mb-8">
              <Image
            ...
            <h2 className="text-3xl lg:text-4xl font-medium tracking-tight mb-6 leading-none text-slate-900">Aesthetic <br />Systems.</h2>
            <p className="text-lg text-slate-700 leading-relaxed mb-8 max-w-sm">
              Visuals that speak your brand. We forge identity and aesthetic systems that immediately position you at the absolute top of your market.
            </p>
            <Link href="/blog/graphic-design" className="inline-flex items-center gap-4 text-sm font-bold uppercase tracking-widest border-b-2 border-slate-900 pb-2 text-slate-900 hover:text-purple-600 hover:border-purple-600 transition-colors w-fit mt-auto">
              Explore Graphic Design <ArrowRight className="w-4 h-4" />
            </Link>
          </div>
