...
export default function GraphicDesignPricing({ hideHeader = false, hideCTA = false }: { hideHeader?: boolean, hideCTA?: boolean } = {}) {
  return (
        ...
        {!hideHeader && (
          <div className="flex flex-col items-center text-center mb-20">
            ...
            <p className="text-lg md:text-xl text-slate-600 max-w-2xl mb-12">
              Invest in visuals that define your brand. Select a package tailored to your design needs.
            </p>
          </div>
        )}
        ...
        {!hideCTA && (
          <div className="w-full pt-20 md:pt-32 pb-10 border-t border-slate-200 mt-20 flex flex-col items-center text-center">
            <h2 className="text-3xl md:text-4xl lg:text-5xl xl:text-[4rem] font-medium tracking-tighter leading-tight mb-8 max-w-none text-slate-900 whitespace-nowrap">
              Ready to <span className="italic font-serif bg-gradient-to-r from-blue-600 to-cyan-500 text-transparent bg-clip-text pr-2">Design?</span>
            </h2>
            <p className="text-xl text-slate-600 max-w-2xl mb-12">
              Let's build your authority from the ground up.
            </p>
