...
const photographyPlans: Plan[] = [
  {
    name: 'Basic',
    price: '₹7,999',
    worth: '₹11,785',
    features: [
      '2 Hours Shoot Duration',
  ...
  },
  {
    ...
    worth: '₹18,749',
    features: [
      '3 Hours Shoot Duration',
      '40 Edited Photos (30 + 10)',
      'Studio Included',
      'Advanced Retouching',
      '2 Outfit Changes',
      'Priority Delivery'
  ...
  },
  {
    ...
    worth: '₹25,539',
    features: [
      '4 Hours Shoot Duration',
      '60 Edited Photos (50 + 10)',
      'Studio Included',
        ...
        {!hideHeader && (
          <div className="flex flex-col items-center text-center mb-20">
            ...
            <p className="text-lg md:text-xl text-slate-600 max-w-2xl mb-12">
              Invest in visuals that define your brand. Select a collection tailored to your creative vision.
            </p>
          </div>
        )}
