        ...
        <div className="flex -space-x-2">
          {testimonials.map((t, i) => (
            <button
              ...
              onClick={() => setActive(i)}
              className={`
                relative w-12 h-12 rounded-full overflow-hidden ring-2 ring-background
                transition-all duration-300 ease-out
                ${active === i ? "z-10 scale-110 ring-offset-1" : "opacity-70 hover:opacity-100 hover:scale-105"}
              `}
            >
